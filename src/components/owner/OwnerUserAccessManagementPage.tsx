            ...
            return (
              <article key={u.id} className="rounded-3xl border border-slate-800 bg-slate-900 p-4 shadow-xl">
                ...
                <div className="mt-4 space-y-2 rounded-2xl border border-slate-800 bg-slate-950 p-3 text-xs">
                  ...
                  <div className="flex justify-between gap-3"><span className="text-slate-500">Contact Number</span><a href={u.phone || u.mobile ? `tel:${u.phone || u.mobile}` : undefined} className="font-bold text-cyan-300 hover:underline">{u.phone || u.mobile || 'Not set'}</a></div>
