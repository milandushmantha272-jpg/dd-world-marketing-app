...
import { Home, Menu, X, Briefcase, BarChart3, MapPin, Target, Wallet, Inbox, UserRound, ShieldCheck, Users, CalendarCheck, FileText, Building2, Trophy, MessageCircle } from 'lucide-react';
...
export const MainNavigation: React.FC = () => {
  ...
  const goHome = () => { const homeItem = items[0]; setActive(homeItem?.label || 'Home'); setOpen(false); if (homeItem) activatePage(homeItem); };
