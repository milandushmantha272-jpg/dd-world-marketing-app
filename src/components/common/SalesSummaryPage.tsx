...
export const SalesSummaryPage: React.FC = () => {
  ...
  const scoped = useMemo(() => {
    ...
    if (role === 'team_leader') return sales.filter((s: any) => s.agentId === currentUser.id || s.teamId === currentUser.teamId);
